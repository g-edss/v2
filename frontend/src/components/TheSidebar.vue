...
<style scoped>
.sidebar { width: var(--sidebar-w); min-height: 100vh; background: linear-gradient(180deg, var(--brand-800) 0%, var(--brand-900) 100%); color: #dbeee2; display: flex; flex-direction: column; position: fixed; top: 0; left: 0; overflow-y: auto; }
.brand { display: flex; align-items: center; gap: 12px; padding: 18px 20px; height: var(--topbar-h); border-bottom: 1px solid rgba(255,255,255,.12); flex-shrink: 0; }
...
.nav-item { display: flex; align-items: center; gap: 12px; padding: 10px 12px; border-radius: 8px; color: #cfe6d8; font-weight: 500; font-size: 14px; transition: background .14s, color .14s; text-decoration: none; }
...
.sub-item { display: flex; align-items: center; gap: 10px; padding: 8px 10px; border-radius: 7px; color: #b0d4bf; font-size: 13px; text-decoration: none; transition: background .14s, color .14s; }
